...
var nativeBridge = (function (exports) {
  ...
  const createProxyUrl = (url, win) => {
    ...
    const bridgeUrl = new URL(
      (_b = (_a = win.Capacitor) === null || _a === void 0 ? void 0 : _a.getServerUrl()) !== null && _b !== void 0
        ? _b
        : '',
    );
  ...
  const initBridge = (w) => {
    ...
    const initVendor = (win, cap) => {
      ...
      IonicWebView.getServerBasePath = (callback) => {
        var _a;
        (_a = Plugins === null || Plugins === void 0 ? void 0 : Plugins.WebView) === null || _a === void 0
          ? void 0
    ...
    const initLogger = (win, cap) => {
      ...
      const isFullConsole = (c) => {
        ...
        return (
          typeof c.groupCollapsed === 'function' || typeof c.groupEnd === 'function' || typeof c.dir === 'function'
        );
      };
      ...
      if (platform == 'android' || platform == 'ios') {
          ...
          Object.defineProperty(document, 'cookie', {
            get: function () {
              ...
              if (platform === 'ios') {
                ...
                return (_c =
                  (_b = (_a = win.CapacitorCookiesDescriptor) === null || _a === void 0 ? void 0 : _a.get) === null ||
                  _b === void 0
                    ? void 0
        ...
        if (doPatchHttp) {
          ...
          window.fetch = async (resource, options) => {
            ...
            if (
              (options === null || options === void 0 ? void 0 : options.body) instanceof FormData &&
            ...
            try {
              ...
              const {
                ...
                (options === null || options === void 0 ? void 0 : options.body) || body || undefined,
                  ...
                  cap
                    ...
                    .then((nativeResponse) => {
                      ...
                      if (this.readyState == 2) {
                        ...
                        this.responseText = (
                          (_a = nativeResponse.headers['Content-Type'] || nativeResponse.headers['content-type']) ===
                            null || _a === void 0
                            ? void 0
